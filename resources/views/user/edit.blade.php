@extends('layouts.app', ['title' => __('Editar Usuario')])
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">
        <i class="ti ti-pencil me-1"></i>{{ __('Editar Usuario') }}
    </li>
@endsection
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center">
                <h5 class="mb-0 fw-bold text-primary-custom" style="color: var(--color-primary) !important;">
                    <i class="ti ti-pencil me-2"></i>{{ __('Editar Usuario') }}
                </h5>
            </div>
                ...
                <form method="POST" action="{{ route('users.update', $user->id) }}" autocomplete="off">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" 
                                       ...
                                       id="last_name"
                                       name="last_name" 
                                       value="{{ old('last_name', $user->customerProfile?->last_name ?? '') }}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="number" 
                                       ...
                                       id="age" 
                                       name="age" 
                                       value="{{ old('age', $user->customerProfile?->age ?? '') }}"
                                       min="1" 
                                       max="150"
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="city" 
                                           name="city" 
                                           value="{{ old('city', $user->customerProfile?->city ?? '') }}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" 
                                       ...
                                       id="profession" 
                                       name="profession" 
                                       value="{{ old('profession', $user->customerProfile?->profession ?? '') }}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" 
                                       ...
                                       id="style" 
                                       name="style" 
                                       value="{{ old('style', $user->customerProfile?->style ?? '') }}"
                                    ...
                                    <select class="form-select" 
                                        ...
                                        @foreach($products as $product)
                                            <option value="{{ $product->id }}" 
                                                    @selected(old('product_id', $user->customerProfile?->product_id) == $product->id)>
                                                {{ $product->title }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <select class="form-select" 
                                        ...
                                        @foreach($colorimetries as $colorimetry)
                                            <option value="{{ $colorimetry->id }}" 
                                                    @selected(old('colorimetry_id', $user->customerProfile?->colorimetry_id) == $colorimetry->id)>
                                                {{ $colorimetry->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('phone_call_date', $user->customerProfile?->phone_call_date ?? '') }}">
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control border-0 shadow-sm bg-white @error('observations') is-invalid @enderror" 
                                          id="observations" 
                                          name="observations" 
                                          placeholder="{{ __('Notas adicionales sobre el cliente') }}">{{ old('observations', $user->customerProfile?->observations ?? '') }}</textarea>
                                @error('observations')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <input type="date" 
                                           ...
                                           id="payment_date" 
                                           name="payment_date"
                                           value="{{ old('payment_date', $user->customerProfile?->payment_date ?? '') }}">
                                </div>
                                @error('payment_date')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group shadow-sm">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('service_completion_date', $user->customerProfile?->service_completion_date ?? '') }}">
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select id="percentage_paid" name="percentage_paid">
                                    <option value="0.00" @if(old('percentage_paid', $user->customerProfile?->percentage_paid ?? '') == '0.00') selected @endif>0%</option>
                                    <option value="75.00" @if(old('percentage_paid', $user->customerProfile?->percentage_paid ?? '') == '75.00') selected @endif>75%</option>
                                    <option value="100.00" @if(old('percentage_paid', $user->customerProfile?->percentage_paid ?? '') == '100.00') selected @endif>100%</option>
                                </select>
                            ...
                            <div class="col-lg-6">
                                ...
                                <select id="percentage_pending" name="percentage_pending" disabled>
                                    <option value="0.00" @if(old('percentage_pending', $user->customerProfile?->percentage_pending ?? '') == '0.00') selected @endif>0%</option>
                                    <option value="25.00" @if(old('percentage_pending', $user->customerProfile?->percentage_pending ?? '') == '25.00') selected @endif>25%</option>
                                </select>
                            ...
                            <div class="col-12">
                                ...
                                <p class="text-muted small mb-3">
                                    <i class="ti ti-info-circle me-1"></i>{{ __('Deja estos campos vacíos si no deseas cambiar la contraseña') }}
                                </p>
                            </div>
                    ...
                    <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary-custom px-5 shadow-sm">
                            <i class="ti ti-check me-2"></i>{{ __('Guardar Cambios') }}
                        </button>
                    </div>
                </form>
            </div>

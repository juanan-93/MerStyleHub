@extends('layouts.app', ['title' => __('Editar Producto')])
...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">
        <i class="ti ti-pencil me-1"></i>{{ __('Editar Producto') }}
    </li>
@endsection
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white py-3 border-bottom d-flex align-items-center">
                <h5 class="mb-0 fw-bold text-primary-custom" style="color: var(--color-primary) !important;">
                    <i class="ti ti-package-edit me-2"></i>{{ __('Editar Producto') }}
                </h5>
            </div>
                    ...
                    <div class="params-section p-4 rounded-3 border">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" 
                                       class="form-control border-0 shadow-sm bg-white @error('title') is-invalid @enderror" 
                                       id="title" 
                                       name="title" 
                                       placeholder="{{ __('Ej: Champú Profesional de Keratina') }}" 
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control border-0 shadow-sm bg-white @error('description') is-invalid @enderror" 
                                          id="description" 
                                          name="description" 
                                          rows="5" 
                                          placeholder="{{ __('Escribe una descripción que ayude a tus clientes a conocer mejor el producto...') }}">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            // Inicializar Summernote para la descripción

@extends('layouts.app', ['title' => __('Crear Cuestionario')])
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Ej: Cuestionario de Colorimetría" required>
                        </div>
                        <div class="col-12">
                            <label for="description" class="form-label fw-semibold">{{ __('Descripción') }}</label>
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Describe brevemente el propósito de este cuestionario..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div id="questionsContainer">
                        {{-- Estado vacío --}}
                        <div id="emptyQuestionsState" class="text-center py-5">
                            <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select select2-status" id="status" name="status" style="width: 100%;">
                            <option value="active" data-icon="ti-circle-check" data-color="#28a745">{{ __('Activo') }}</option>
                            <option value="inactive" data-icon="ti-circle-x" data-color="#dc3545">{{ __('Inactivo') }}</option>
                        </select>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        ...
                        <span class="fw-semibold" id="testQuestions">0</span>
                    </div>
                    <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                        <span class="text-muted d-flex align-items-center gap-1">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary-custom w-100 mb-2">
                        <i class="ti ti-device-floppy me-1"></i> {{ __('Guardar Cuestionario') }}
                    </button>
